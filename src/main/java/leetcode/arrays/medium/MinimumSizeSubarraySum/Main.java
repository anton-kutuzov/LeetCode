...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.minSubArrayLen(0, array2) + " --> 1");
        System.out.println(solution.minSubArrayLen(697439, array1) + " --> 132");
        System.out.println(solution.minSubArrayLen(7, array2) + " --> 2");
        System.out.println(solution.minSubArrayLen(11, array3) + " --> 3");
        System.out.println(solution.minSubArrayLen(11, array4) + " --> 1");
        System.out.println(solution.minSubArrayLen(1, array4) + " --> 1");
        System.out.println(solution.minSubArrayLen(11, array5) + " --> 0");
        System.out.println(solution.minSubArrayLen(1, array5) + " --> 1");
        System.out.println(solution.minSubArrayLen(11, array6) + " --> 1");
        System.out.println(solution.minSubArrayLen(1, array6) + " --> 1");
        System.out.println(solution.minSubArrayLen(11, array7) + " --> 0");
        System.out.println(solution.minSubArrayLen(1, array7) + " --> 1");
        System.out.println(solution.minSubArrayLen(1, new int[]{}) + " --> 0");
        System.out.println(solution.minSubArrayLen(1, array8) + " --> 1");
        System.out.println(solution.minSubArrayLen(2, array8) + " --> 1");
        System.out.println(solution.minSubArrayLen(3, array8) + " --> 2");
        System.out.println(solution.minSubArrayLen(4, array8) + " --> 0");
        System.out.println(solution.minSubArrayLen(7, array9) + " --> 2");
    }
